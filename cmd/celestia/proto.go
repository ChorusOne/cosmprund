// A copy of celestia's proto/tendermint/store/types.pb.go
package celestia
...
// CelestiaTxInfo describes the location of a tx inside a committed block
// as well as the result of executing the transaction and the error log output.
type CelestiaTxInfo struct {
...
func (m *CelestiaTxInfo) Reset()         { *m = CelestiaTxInfo{} }
func (m *CelestiaTxInfo) String() string { return proto.CompactTextString(m) }
func (*CelestiaTxInfo) ProtoMessage()    {}
func (*CelestiaTxInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff9e53a0a74267f7, []int{1}
}
func (m *CelestiaTxInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CelestiaTxInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CelestiaTxInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CelestiaTxInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CelestiaTxInfo.Merge(m, src)
}
func (m *CelestiaTxInfo) XXX_Size() int {
	return m.Size()
}
func (m *CelestiaTxInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_CelestiaTxInfo.DiscardUnknown(m)
}

var xxx_messageInfo_CelestiaTxInfo proto.InternalMessageInfo

func (m *CelestiaTxInfo) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *CelestiaTxInfo) GetIndex() uint32 {
	if m != nil {
		return m.Index
	}
	return 0
...
func (m *CelestiaTxInfo) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *CelestiaTxInfo) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*CelestiaTxInfo)(nil), "tendermint.store.CelestiaTxInfo")
}
...
func (m *CelestiaTxInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CelestiaTxInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CelestiaTxInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CelestiaTxInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CelestiaTxInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CelestiaTxInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CelestiaTxInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
